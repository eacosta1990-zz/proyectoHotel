...
public class HabitacionABM {
	...
	public List<Habitacion> traerHabitacionDisponible() {
		return dao.traerHabitacionDisponible();
	}
	public List<Habitacion> traerHabitacionPorTipo(int tipo,int capacidad)throws Exception {
		List<Habitacion> habitaciones = dao.traerHabitacionPorTipo(tipo,capacidad);
		if (habitaciones==null){
			throw new Exception("SIN HABITACION DISPONIBLE");
		}
		else{
			return habitaciones;
		}
